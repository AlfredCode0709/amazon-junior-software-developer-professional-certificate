public class Main {
    public static void main(String[] args) {
        ...
        // Please initialize this reference variable to create an object of the
        // UserInput class// To be implemented by the learner
        ...
        // A Switch statement that determines how user input for weight and height
        // should be obtained based on the BMI system
        switch (bmiSystem.toUpperCase()) {
            // The case of IMPERIAL BMI system
            case "IMPERIAL":
                // Invoking the obtainWeight() method of the UserInput class and assigning it to
                // the variable weight
                weight = userInput.obtainWeight(bmiSystem);
                // Invoking the obtainHeight() method of the UserInput class and assigning it to
                // the variable height
            ...
            case "":
                // Please display a message asking the user to enter a valid BMI system in case
                // of invalid input
        ...
        // Invoking the getBMICategory() method of the BMICalculator class and assigning
        // the result to the bmiCategory variable
