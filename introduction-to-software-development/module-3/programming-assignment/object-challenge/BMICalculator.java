...
public class BMICalculator {
    ...
    // Default no arguments constructor to initialize the 4 properties to some
    // initial values
    ...
    // Method that calculates the BMI using the Imperial system, taking in weight in
    // Pounds and height in Inches
    ...
    // Method that calculates the BMI using the Metric system, taking in weight in
    // Kilos and height in Meters
