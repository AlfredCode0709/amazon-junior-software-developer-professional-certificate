...
public class UserInput {
    ...
    // Method that obtains user input for the weight in Pounds or Kilos, based on
    // the entered BMI system
    public double obtainWeight(String bmiSystem) {
        ...
        // The loop that controls obtaining user input for weight until a valid value is
        // entered
        while (isInvalidInput) {
            // Scanner that captures user input for the weight value
            Scanner input = new Scanner(System.in);

            // A Switch statement that determines if weight should be obtained in Pounds or
            // Kilos based on the BMI system
            ...
            if (input.hasNextDouble()) {
                ...
                // Display a message asking the user to input a valid value, in case of invalid
                // user input
    ...
    // Method that obtains user input for the height in Inches or Meters, based on
    // the entered BMI system
    public double obtainHeight(String bmiSystem) {
        ...
        // The loop that controls obtaining user input for height until a valid value is
        // entered
        while (isInvalidInput) {
            // Scanner that captures user input for the height value
            Scanner input = new Scanner(System.in);

            // A Switch statement that determines if height should be obtained in Inches or
            // Meters based on the BMI system
            switch (bmiSystem.toUpperCase()) {
                // The case of IMPERIAL BMI system
                case "IMPERIAL":
