...
public class DrivingSimulationSolution {
    ...
    // Initial position of the gear is P (i.e. Park) so, initializing variable gear
    // with same
    ...
    // displayDashboard method displays the car dashboard with current state and
    // menu options
    ...
    // getUserChoice function has a return type int which stores the input received
    // from the user
    ...
    public static void processChoice(int choice) {
        switch (choice) {
            ...
            case 5:
                exitSimulation();
                break;
            // Handle the invalid choice (Any other input from the user except choices given
            // above)
            default:
    ...
    public static void accelerate() {
        ...
        if (isEngineOn && !gear.equals("P")) {
            ...
            // If the condition is not met, print a message stating acceleration is not
            // possible
